...
public class WalkerGenerator : MonoBehaviour
{
    ...
    void InitializeGrid()
    {
        ...
        floorTileMap.SetTile(TileCenter, FloorTile);
    ...
    IEnumerator CreateFloors()
    {
        while ((float)TileCount / (float)gridHandler.Length < FillPercentage)
        {
            ...
            foreach (WalkerObject curWalker in Walkers)
            {
                ...
                {
                    floorTileMap.SetTile(curPos, FloorTile);
                    TileCount++;
        ...
        for (int x = 0; x < gridHandler.GetLength(0) - 1; x++)
        {
            for (int y = 0; y < gridHandler.GetLength(1) - 1; y++)
            {
                if (gridHandler[x, y] == Grid.FLOOR)
                {
                    ...
                    {
                        floorTileMap.SetTile(new Vector3Int(x + 1, y, 0), FloorTile);
                    ...
                    {
                        floorTileMap.SetTile(new Vector3Int(x, y + 1, 0), FloorTile);
                    ...
                    // {
                    //     wallTileMap.SetTile(new Vector3Int(x + 1, y + 1, 0), WallTile);
